...
const Highmedianelec = () => {
const position=[51.505, -0.09]

        ReactDOM.render(
                                  <h1>10 Highest Median Electricity usage by post code</h1>
                                  ,document.getElementById('head1')
                        );


let jsonstr= async() => {
                var x= await axios({url: process.env.REACT_APP_APIADD + '/api/medianelectricityhigh'});
                  return x.data;
